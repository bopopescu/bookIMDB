books_head = ['Image', 'Title', 'ISBN',
              'Date Published', 'Publishing Company', 'Author']
authors_head = ['Photo', 'Name', 'Nationality',
                'Date of Birth', 'Alma Mater', 'Education', 'Website']
publishers_head = ['Image', 'Name', 'Location',
                   'Founded', 'Parent Company', 'Website']
...
books_data = [{
    ...
    'id': '3',
    "google_id": "Wpjqz9x2cJQC",
    "title": "All the President's Men",
    "isbn": "9781471104664",
    "publication_date": "2012-12-11",
    "image_url": "https://books.google.com/books/content/images/frontcover/Wpjqz9x2cJQC?fife=w500",
    ...
    "authors": [
        ...
        },
        {
            ...
            "description": "Carl Bernstein is an American investigative journalist and author.\nWhile a young reporter for The Washington Post in 1972, Bernstein was teamed up with Bob Woodward; the two did much of the original news reporting on the Watergate scandal. ",
            "wikipedia_url": "https://en.wikipedia.org/wiki/Carl_Bernstein",
            "image_url": "http://upload.wikimedia.org/wikipedia/commons/thumb/d/db/Carl_bernstein_2007.jpg/220px-Carl_bernstein_2007.jpg"
        }]}]
...
publishers_data = [{
    ...
    'location': 'London',
    'description': 'Bloomsbury Publishing Plc is a British independent, worldwide publishing house of fiction and non-fiction. It is a constituent of the FTSE SmallCap Index. ',
    'wikipedia_url': 'https://en.wikipedia.org/wiki/Bloomsbury_Publishing',
    'image_url': 'http://upload.wikimedia.org/wikipedia/commons/thumb/8/80/Bloomsbury-publishing-logo.PNG/300px-Bloomsbury-publishing-logo.PNG',
    'website': 'http://Bloomsbury'
}, {
    'id': '3',
    'founded': '1924',
    'name': 'Simon & Schuster',
    ...
    'wikipedia_url': 'https://en.wikipedia.org/wiki/Simon_%26_Schuster',
    'description': 'Simon &amp; Schuster, Inc., a division of CBS Corporation, is a publisher founded in New York City in 1924 by Richard L. Simon and M. Lincoln Schuster. It is one of the largest English-language publishers, formerly known as the "Big 6", now known as the "Big Five". It publishes over 2,000 titles annually under 35 different imprints.',
    'parent_company': 'CBS Corporation',
    'image_url': 'http://upload.wikimedia.org/wikipedia/en/thumb/d/db/Simon_and_Schuster.svg/200px-Simon_and_Schuster.svg.png',
    'website': 'http://www.simonandschuster.com'
}]
